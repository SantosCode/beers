...
public class BeerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDuplicateKeyException(MongoWriteException ex, WebRequest request) {
        return getObjectResponseEntity(ex, request);
    }
    ...
    public ResponseEntity<Object> handleParametroException(ParametroException ex, WebRequest request) {
        return getObjectResponseEntity(ex, request);
    }

    private ResponseEntity<Object> getObjectResponseEntityListErros(Exception ex, HttpHeaders headers, WebRequest request) {
    ...
    private ResponseEntity<Object> getObjectResponseEntity(Exception ex, WebRequest request) {
        ...
        String mensagemDev = ExceptionUtils.getRootCauseMessage(ex);
        log.error(mensagemDev, ex);
        return handleExceptionInternal(ex, new Erro(mensagemUsuario, mensagemDev), new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
    }
